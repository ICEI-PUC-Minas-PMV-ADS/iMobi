  ...
  return (
    <header className="container mx-auto">
      <nav className="z-50 py-5 md:flex md:items-center md:justify-between">
        ...
        <ul className={`md:flex md:items-center md:z-auto md:static absolute   w-full left-0 md:w-auto md:py-0 py-2 md:pl-0  md:opacity-100 ${isMobileMenuVisible ? "opacity-100 left-[0px]" : "opacity-0 left-[-400px]"} transition-all ease-in-out duration-500  pb-6`}>
