...
{
    var mongoDbSettings = builder.Configuration.GetSection("MongoDbSettings").Get<MyMongoDbSettings>();
    var mongoClientSettings = MongoClientSettings.FromConnectionString(mongoDbSettings.ConnectionString);
    return new MongoClient(mongoClientSettings);
});

builder.Services.Configure<MyMongoDbSettings>(builder.Configuration.GetSection("MongoDbSettings"));
